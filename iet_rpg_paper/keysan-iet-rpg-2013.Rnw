...
opts_chunk$set(fig.width=3.6,fig.height=3,dev='pdf',dev.args=list(pointsize=8, family="serif"), cache=TRUE, crop=TRUE, echo=FALSE)
...
<<plot1gpm, fig.cap="Mass of the medium speed permanent magnet gnenerator vs torque.">>=
setwd("../generator/")
