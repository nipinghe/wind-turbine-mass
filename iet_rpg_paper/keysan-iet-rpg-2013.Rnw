...
\begin{equation}
<<<<<<< HEAD
	Mass_{low-speed-shaft}(t)= 1.35 \times P(MW)^1.44 
=======
...
\begin{equation}
<<<<<<< HEAD
	Main-Bearing(kg)=(\frac{R}{75}-0.033)*0.0092*R^2.5
=======
...
<<induction_generator_eeficiency,  fig.cap="Mass of the induction generator vs torque.">>=
